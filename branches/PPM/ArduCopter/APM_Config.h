...
// But for PPM on PL1 (v1) or PWM Rx mode you have to enable sonar - few lines below.
...
// if you use v2 board PWM you have to enable sonar here - but you can disable it in MP if not used
